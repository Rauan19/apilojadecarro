  ...
  return (
    <div className="flex min-h-screen bg-background" style={brandStyle}>
      <aside className="hidden w-60 shrink-0 border-r border-border bg-white lg:block xl:w-64">
        <div className="fixed h-screen w-60 border-r border-border bg-white xl:w-64">
          <AppSidebar />
        </div>
      </aside>
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col bg-background">
        ...
        <main
          ...
          className="page-fade-in min-w-0 flex-1 overflow-x-hidden bg-background px-3 py-4 sm:px-5 sm:py-5 lg:px-8 lg:py-6"
        >
          <Outlet />
        </main>
      </div>
